# TradingView Webhook Receiver (.NET 8 C#)

A production-ready webhook receiver for TradingView alerts built with ASP.NET Core 8.0 and configured for IIS hosting.
...
**Webhook endpoint:**
```
POST http://localhost:5000/api/webhook/receive
